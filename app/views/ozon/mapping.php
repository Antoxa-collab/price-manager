<?php
/**
 * Страница сопоставления товаров с Ozon
 * 3-шаговый интерфейс: Загрузка -> Сопоставление -> Просмотр
 */
$pageTitle = 'Сопоставление товаров Ozon';
$pageScript = 'ozon-mapping';
    ...
    <div class="col-12">
        <div class="steps-container d-flex justify-content-center align-items-center">
            ...
            <div class="step active" data-step="1" id="step1Indicator">
                ...
                <div class="step-label">Загрузить с Ozon</div>
            </div>
...
<div class="step-content" id="step1Content">
    <div class="card bg-dark border-secondary">
        <div class="card-body text-center py-5">
            <i class="bi bi-cloud-download display-1 text-info mb-3"></i>
            <h5 class="mb-3">Загрузите товары с Ozon</h5>
            <p class="text-muted mb-4">
                Нажмите кнопку ниже, чтобы синхронизировать список товаров из вашего магазина на Ozon
            </p>
            <button type="button" class="btn btn-info btn-lg" id="syncOzonBtn">
                <i class="bi bi-arrow-repeat me-2"></i>
                Загрузить товары с Ozon
            </button>
            ...
            <div class="mt-4 d-none" id="syncProgress">
                ...
                <span class="text-muted" id="syncProgressText">Загрузка товаров с Ozon...</span>
            </div>
        </div>
    </div>
    ...
    <div class="text-center mt-3 d-none" id="skipStep1">
        ...
        <div class="text-muted small mt-2">
            У вас уже загружено <span id="cachedProductsCount">0</span> товаров с Ozon
        </div>
    </div>
</div>
        ...
        <div class="col-lg-2 d-flex align-items-center justify-content-center mb-4">
            <div class="text-center mapping-actions">
                ...
                <div class="selected-info mb-4 p-2 rounded bg-body-tertiary d-none" id="selectedInfo">
                    ...
                    <div class="small text-truncate" id="selectedOzonProduct">-</div>
                </div>
            </div>
        </div>

        <!-- Правая панель: Товары Ozon -->
        <div class="col-lg-5 mb-4">
            <div class="card bg-dark border-secondary h-100">
                <div class="card-header border-secondary d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        Товары на Ozon
                        <span class="badge bg-info ms-2" id="ozonProductsCount">0</span>
                    </div>
                    <div class="btn-group btn-group-sm" role="group">
                        <input type="radio" class="btn-check" name="ozonFilter" id="filterAll" value="all" checked>
                        <label class="btn btn-outline-secondary" for="filterAll">Все</label>

                        <input type="radio" class="btn-check" name="ozonFilter" id="filterUnmapped" value="unmapped">
                ...
                <div class="card-body p-0">
                    <!-- Поиск -->
                    <div class="p-3 border-bottom border-secondary">
                        <input type="text" class="form-control form-control-sm" id="searchOzonProducts" placeholder="Поиск по названию, артикулу...">
                    </div>

                    <!-- Список товаров -->
                    <div class="list-group list-group-flush overflow-auto" id="ozonProductsList" style="max-height: 450px;">
                        <div class="text-center text-muted py-4">
                            <i class="bi bi-hourglass-split"></i> Загрузка...
                        </div>
                    </div>
...
<div class="step-content d-none" id="step3Content">
        ...
        <div class="col-md-4">
            <div class="card bg-dark border-secondary">
                <div class="card-body py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <div class="text-muted small">Товаров на Ozon</div>
                            <h4 class="mb-0" id="statOzonProducts">-</h4>
                        </div>
                        <i class="bi bi-cloud display-6 text-info"></i>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="table table-dark table-striped table-hover mb-0" id="mappingsTable">
                    <thead>
                        <tr>
                            ...
                            <th class="text-end" style="width: 120px;">Цена Ozon</th>
    ...
    <div class="d-flex justify-content-between mt-3">
        ...
        <a href="/ozon" class="btn btn-primary">
        ...
        <div class="modal-content bg-dark">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-text">Сколько листов/штук в одной карточке на Ozon</div>
                </div>
            </div>
            <div class="modal-footer border-secondary">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Отмена</button>
