<?php
/**
 * CLI скрипт для выполнения прямых SQL команд через PHP
 * Запуск: docker exec price-manager-php php /var/www/html/cli/run-sql.php
 */
...
try {
    ...
    foreach ($prompts as $prompt) {
        ...
        echo "Добавляем примеры для '{$promptName}' (ID={$promptId})...\n";
    ...
    echo "Всего активных примеров в БД: {$count}\n";
